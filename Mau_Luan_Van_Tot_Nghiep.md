...
<p align="center" style="margin-top: 0.2in; font-style: italic; margin-bottom: 0.05in;">Bảng 4.2. Bộ kiểm thử tự động Pytest (backend/tests/)</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Bảng 4.2 tổng hợp theo file test. Dưới đây, <b>38 kịch bản</b> được phân thành <b>7 nhóm chức năng</b> và liệt kê chi tiết tại Bảng 4.3 (ánh xạ FR từ Bảng 3.1):</p>
...
<p align="center" style="margin-top: 0.2in; font-style: italic; margin-bottom: 0.05in;">Bảng 4.3. Chi tiết từng kịch bản kiểm thử tự động (38 test cases)</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Ở tầng giao diện trực quan (Frontend), đồ án tiến hành kiểm thử các luồng thao tác thực tế nhằm đảm bảo trải nghiệm nghiệp vụ xuyên suốt, không bị đứt gãy. Bảng 4.4 dưới đây mô tả các kịch bản tiêu biểu:</p>

<p align="center" style="margin-top: 0.2in; font-style: italic; margin-bottom: 0.05in;">Bảng 4.4. Danh sách Kịch bản Kiểm thử Hộp đen</p>
<table width="100%" border="1" cellpadding="8" cellspacing="0" style="display: table; width: 100%; border-collapse: collapse; border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word; table-layout: fixed; word-wrap: break-word; word-break: break-word; white-space: normal;">
  <tr style="background-color: #f2f2f2; font-weight: bold;">
