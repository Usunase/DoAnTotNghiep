...
<div style="max-width: 650px; margin: 0 auto; font-family: 'Times New Roman', serif; font-size: 14pt; line-height: 1.6;">
  <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%;">
    <tr>
      <td width="35%" style="border: 1px solid #000; padding: 10px; font-weight: bold;">Ngành:</td>
      <td width="65%" style="border: 1px solid #000; padding: 10px;">Khoa Học Máy Tính</td>
    </tr>
    <tr>
      <td style="border: 1px solid #000; padding: 10px; font-weight: bold;">Mã số:</td>
      <td style="border: 1px solid #000; padding: 10px;">7480101</td>
    </tr>
    <tr>
      <td style="border: 1px solid #000; padding: 10px; font-weight: bold;">Khóa:</td>
      <td style="border: 1px solid #000; padding: 10px;">2022</td>
    </tr>
  </table>

  <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%; border-top: none;">
    <tr>
      <td width="35%" style="border: 1px solid #000; border-top: none; padding: 10px; font-weight: bold;">Sinh viên thực hiện:</td>
      <td width="65%" style="border: 1px solid #000; border-top: none; padding: 10px;">Hà Minh Chiến</td>
    </tr>
    <tr>
      <td style="border: 1px solid #000; padding: 10px; font-weight: bold;">Mã số sinh viên:</td>
      <td style="border: 1px solid #000; padding: 10px;">2202095</td>
    </tr>
    <tr>
      <td style="border: 1px solid #000; padding: 10px; font-weight: bold;">Giảng viên hướng dẫn:</td>
      <td style="border: 1px solid #000; padding: 10px;">Thầy Trần Ngọc Anh</td>
    </tr>
  </table>
</div>

<p align="center" style="margin-top: 80px; margin-bottom: 40px; font-family: 'Times New Roman', serif;">
  <b style="font-size: 14pt; text-transform: uppercase;">Tây Ninh, tháng 06 năm 2026</b>
</p>

<div style="page-break-before: always;"></div>

<p align="center" style="margin-top: 40px; margin-bottom: 30px;">
  <b style="font-size: 16pt;">TRANG PHÊ DUYỆT</b>
</p>

<p align="justify" style="line-height: 150%; margin-bottom: 10px;">
  Luận văn đã được trình và bảo vệ trước Hội đồng chấm tiểu luận tốt nghiệp.
</p>
<p align="justify" style="line-height: 150%; margin-bottom: 10px;">
  Ngày bảo vệ: ....../....../2026
</p>
<p align="justify" style="line-height: 150%; margin-bottom: 40px;">
  Kết quả: ....../10 điểm
</p>

<div style="display: flex; justify-content: space-between; margin-top: 30px; margin-bottom: 20px; font-family: 'Times New Roman', serif;">
  <div style="width: 50%; text-align: center;">
    <b style="font-size: 12pt;">GIẢNG VIÊN HƯỚNG DẪN</b><br>
    <i style="font-size: 11pt;">(Ký và ghi rõ họ tên)</i>
    <div style="height: 100px;"></div>
  </div>
  <div style="width: 50%; text-align: center;">
    <b style="font-size: 12pt;">GIẢNG VIÊN PHẢN BIỆN</b><br>
    <i style="font-size: 11pt;">(Ký và ghi rõ họ tên)</i>
    <div style="height: 100px;"></div>
  </div>
</div>

<div style="text-align: center; font-family: 'Times New Roman', serif; margin-bottom: 50px;">
  <b style="font-size: 12pt;">CHỦ TỊCH HỘI ĐỒNG</b><br>
  <i style="font-size: 11pt;">(Ký và ghi rõ họ tên)</i>
  <div style="height: 100px;"></div>
</div>
...
<p align="center" style="margin-top: 40px; margin-bottom: 30px;">
  <b style="font-size: 16pt;">LỜI CẢM ƠN</b>
</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Bên cạnh mô hình dự đoán, nghiên cứu thiết kế một Động cơ giải thích rule-based độc lập (ExplanationEngine) dựa trên các đặc trưng kinh nghiệm (Heuristics). Thay vì tích hợp trực tiếp Heuristics vào quá trình dự đoán toán học, hệ thống chỉ chạy module này sau khi PhoBERT đã tính toán xong xác suất, nhằm sinh ra các câu văn tiếng Việt minh bạch hóa lý do bài báo bị cảnh báo (ví dụ: lạm dụng viết hoa, văn phong giật gân).</p>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Kết quả thực nghiệm trên tập kiểm thử (30% dữ liệu) cho thấy kiến trúc PhoBERT Fine-tuned Sequence Classification đạt Accuracy 96,32%, F1-Score 93,42%, với Precision 92,45% và Recall 94,41%. Đồng thời, việc tách biệt cơ chế Heuristics thành Động cơ giải thích độc lập cho phép hệ thống trích xuất các dấu hiệu hình thức để giải thích lý do phân loại, qua đó hạn chế tính chất "hộp đen" của mô hình học sâu.</p>

<p align="justify" style="line-height: 150%; margin-top: 20px; margin-bottom: 0.06in"><b>Từ khóa: </b> Phát hiện tin giả tiếng Việt, PhoBERT, Giải thích Heuristic, Học máy, Xử lý ngôn ngữ tự nhiên.</p>

<div style="page-break-before: always; margin-top: 50px; margin-bottom: 30px; text-align: center; font-family: 'Times New Roman', serif;">
  <b style="font-size: 16pt;">ABSTRACT</b>
</div>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">The dataset utilized in this study comprises <b>over 22,000 labeled records</b> synthesized from multiple sources for training. The distribution between the two classes is relatively balanced, helping to minimize the impact of Class Imbalance during the model training phase. This establishes a favorable condition for an objective and reliable evaluation of the model's performance through an independent hold-out test set (76-12-12 split).</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Experimental results demonstrate that the proposed PhoBERT Fine-tuned Sequence Classification architecture achieves excellent performance (93.42% F1-Score) on the research dataset. Furthermore, decoupling the heuristics into an independent Explanation Engine helps alleviate the "black-box" nature of deep learning, providing users with intuitive, text-based reasoning for the system's classification decisions.</p>

<p align="justify" style="line-height: 150%; margin-top: 20px; margin-bottom: 0.06in"><b>Keywords: </b> Fake News Detection, PhoBERT, Heuristic Explanation, Rule-based Engine, Text-only Classification, NLP.</p>
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.2in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">1.6. Bố cục đồ án</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>12</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0in; line-height: 150%;">
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">2.2.4. Phân loại Chuỗi (Sequence Classification)</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>16</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">2.4.1. Thư viện Trí tuệ Nhân tạo và Xử lý Ngôn ngữ</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>20</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.2in; line-height: 150%;">
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">2.5.2. Lựa chọn Kiến trúc PhoBERT Fine-tuned Sequence Classification</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>21</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">3.1.4. Phương pháp Trích xuất biểu diễn ngữ nghĩa bằng PhoBERT</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>24</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">3.1.5. Phương pháp Mô hình hóa mạng đa tầng (PhoBERT Sequence Classification)</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>24</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
...
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.6in; line-height: 150%;">
    <span style="font-weight: normal;"><a href="#" style="color: black; text-decoration: none;">4.4.1.1. Phân nhóm và chi tiết 38 test cases (Bảng 4.4)</a></span>
    <span style="flex-grow: 1; border-bottom: 2px dotted #000; margin: 0 10px; position: relative; top: -4px;"></span>
    <span>54</span>
</div>
<div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 0.07in; margin-left: 0.4in; line-height: 150%;">
...
<table width="100%" border="1" cellpadding="8" cellspacing="0" style="display: table; width: 100%; border-collapse: collapse; border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word; table-layout: fixed; word-wrap: break-word; word-break: break-word; white-space: normal;">
  ...
  <tr><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word;">Bảng 4.1</td><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word;">Hiệu năng của mô hình PhoBERT Fine-tuned Sequence Classification</td><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word; text-align: center; font-weight: bold;">38</td></tr>
  ...
  <tr><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word;">Bảng 4.4</td><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word;">Chi tiết từng kịch bản kiểm thử tự động (38 test cases)</td><td style="border: 1px solid #000; white-space: normal; word-wrap: break-word; word-break: break-word; text-align: center; font-weight: bold;">41</td></tr>
</table>
<p align="center" style="line-height: 100%; margin-bottom: 0.06in"><font color="#000000"><font size="4" style="font-size: 14pt"><b>DANH
...
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Phương pháp thống kê và đánh giá (Statistical Evaluation):</b> Sử dụng phương pháp đánh giá trên tập kiểm thử độc lập (Hold-out Test Set) và các độ đo tiêu chuẩn trong Học máy (Precision, Recall, F1-Score, Ma trận nhầm lẫn - Confusion Matrix) để đánh giá định lượng hiệu năng mô hình một cách khách quan.</li>
  <li style="margin-bottom: 0.05in;"><b>Phương pháp kỹ nghệ phần mềm (Software Engineering):</b> Áp dụng quy trình phát triển hiện đại để thiết kế kiến trúc phân tán 3 tầng (Client-Server), lập trình giao diện người dùng (Next.js) và tích hợp API máy chủ (FastAPI), qua đó hiện thực hóa mô hình AI thành một phần mềm thực tiễn.</li>
</ul>

<h2>1.5. Ý nghĩa khoa học và thực tiễn</h2>
<p align="justify" style="line-height: 150%; margin-bottom: 0.06in; text-indent: 0.5in"><b>Về mặt khoa học:</b> Đồ án cung cấp một hướng tiếp cận hiệu quả trong việc ứng dụng kỹ thuật Tinh chỉnh (Fine-tuning) mô hình ngôn ngữ tiếng Việt (PhoBERT) nguyên bản cho tác vụ Phân loại Chuỗi trên tập ngữ liệu tiếng Việt đặc thù. Đặc biệt, việc tích hợp phương pháp Giải thích Heuristic góp phần cải thiện khả năng giải thích của mô hình, đóng góp thêm tài liệu tham khảo giá trị cho lĩnh vực Trí tuệ Nhân tạo Minh bạch (Explainable AI - XAI).</p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.06in; text-indent: 0.5in"><b>Về mặt thực tiễn:</b> Đề tài đã xây dựng thành công nền tảng phần mềm ShieldAI hoàn thiện. Đây là một công cụ hỗ trợ kiểm chứng thông tin, cung cấp cho cộng đồng mạng Việt Nam khả năng nhận diện tin giả nhanh chóng kèm theo những lời giải thích dễ hiểu. Bên cạnh đó, với kiến trúc API linh hoạt, hệ thống có tiềm năng rất lớn để mở rộng và tích hợp vào các mạng xã hội hoặc các công cụ kiểm duyệt nội dung tự động của các cơ quan báo chí trong tương lai.</p>
...
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Chương 4 - Kết quả thực nghiệm:</b> Công bố các số liệu huấn luyện mô hình, kết quả kiểm thử hệ thống tự động (Unit Test) và minh họa giao diện sử dụng thực tế của phần mềm ShieldAI.</li>
  <li style="margin-bottom: 0.05in;"><b>Chương 5 - Tổng kết và hướng phát triển:</b> Đúc kết lại những thành tựu đã đạt được, chỉ ra các hạn chế còn tồn đọng và đề xuất các hướng nâng cấp hệ thống trong tương lai.</li>
</ul>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.06in; text-indent: 0.5in">Trong thực tiễn kiểm chứng thông tin (Fact-checking), việc xác định một văn bản có phải tin giả hay không hiếm khi chỉ dựa vào một yếu tố đơn lẻ, mà đòi hỏi sự đánh giá đa chiều qua nhiều khía cạnh trọng yếu. Dưới đây là các tiêu chí cốt lõi thường được sử dụng để phân loại và nhận diện tin giả:</p>
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Nguồn đăng tin và tính xác thực (Source Authenticity):</b> Tin tức có bắt nguồn từ cơ quan báo chí chính thống, tổ chức uy tín hay từ các tên miền giả mạo, tài khoản nặc danh? Việc bài báo mạo danh hoặc thiếu trích dẫn nguồn gốc rõ ràng là dấu hiệu cảnh báo cao.</li>
  <li style="margin-bottom: 0.05in;"><b>Văn phong và ngôn ngữ thao túng (Sensationalist Language):</b> Tin giả thường lạm dụng chữ in hoa, các từ ngữ mang tính kích động ("sốc", "kinh hoàng"), sử dụng tiêu đề giật gân (Clickbait) không khớp với nội dung, hoặc bài viết chứa nhiều lỗi chính tả.</li>
  <li style="margin-bottom: 0.05in;"><b>Mục đích kích động cảm xúc (Emotional Manipulation):</b> Các nội dung này được thiết kế có chủ đích nhằm khơi gợi các phản ứng cảm xúc cực đoan (sợ hãi, phẫn nộ, hoang mang) để thúc đẩy người đọc chia sẻ nhanh chóng thay vì dừng lại kiểm chứng.</li>
  <li style="margin-bottom: 0.05in;"><b>Thiếu vắng bằng chứng và bối cảnh sai lệch (Lack of Evidence & Context):</b> Đưa ra những khẳng định đanh thép nhưng không đi kèm số liệu, không trích dẫn chuyên gia, hoặc sử dụng hình ảnh/video cũ bị cắt ghép, gán ghép vào bối cảnh mới sai lệch.</li>
  <li style="margin-bottom: 0.05in;"><b>Đối chiếu chéo và mức độ lan truyền (Cross-verification & Spread):</b> Khi đối chiếu với các nền tảng báo chí lớn khác thì không có thông tin xác nhận sự kiện đó, trong khi trên mạng xã hội lại lan truyền với tốc độ chóng mặt, thường do các tài khoản ảo (bot) phát tán.</li>
</ul>
<p align="justify" style="line-height: 150%; margin-bottom: 0.06in; text-indent: 0.5in">Dựa trên các tiêu chí nhận diện thực tiễn này, hệ thống ShieldAI được thiết kế nhằm tự động hóa quá trình kiểm duyệt, trong đó đặc biệt tập trung sức mạnh tính toán để giải quyết triệt để khía cạnh phân tích ngôn ngữ, văn phong thao túng và cảm xúc thông qua kiến trúc học sâu PhoBERT kết hợp với cơ chế Heuristics độc lập.</p>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.06in; text-indent: 0.5in"><b>PhoBERT</b> là một mô hình ngôn ngữ tiền huấn luyện tiên phong được huấn luyện dành riêng cho tiếng Việt. Về mặt kiến trúc cốt lõi, PhoBERT không kế thừa nguyên bản BERT của Google, mà dựa trên biến thể được tối ưu hóa mạnh mẽ hơn là <b>RoBERTa (Robustly Optimized BERT Pretraining Approach)</b>.</p>
...
<br><i>Hình 3.1: Sơ đồ Kiến trúc Hệ thống Phân tán</i>
</p>
...
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Bước 4: Giải thích (ExplanationEngine):</b> Module rule-based quét văn bản gốc (viết hoa, dấu chấm than, văn phong giật gân), kết hợp xác suất suy luận để sinh JSON giải thích tiếng Việt.</li>
</ul>
...
<pre style="white-space: pre-wrap; font-family: monospace; background-color: #f5f5f5; padding: 10px; border: 1px solid #ccc; line-height: 1.5; overflow-x: auto;"><code>ALGORITHM: PhoBERT Sequence Classification &amp; Rule-based Explanation
INPUT:
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in"><b>Thứ ba, về mặt Thiết kế Thuật toán Lõi:</b> Lưu đồ thuật toán tuần tự mô tả pipeline <b>PhoBERT Fine-tuned Sequence Classification</b>: AutoModelForSequenceClassification (Logits) → Softmax → verdict 3 mức → ExplanationEngine rule-based.</p>
...
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Hệ sinh thái Backend & AI:</b> 
    <ul style="list-style-type: circle; margin-top: 0.05in; margin-bottom: 0.05in;">
      <li style="margin-bottom: 0.05in;"><b>Ngôn ngữ:</b> Sử dụng phiên bản <code>Python 3.10+</code> (toàn bộ mã nguồn chạy bên trong một môi trường ảo Virtual Environment riêng biệt để cách ly các thư viện).</li>
      ...
      <li style="margin-bottom: 0.05in;"><b>Thư viện AI Lõi:</b> <code>PyTorch</code> + <code>Transformers</code> (PhoBERT embedding), <code>Scikit-learn</code> (metrics F1/Precision, Confusion Matrix).</li>
    </ul>
  </li>
  ...
  <li style="margin-bottom: 0.05in;"><b>Hệ quản trị Cơ sở dữ liệu:</b> Để phục vụ mục đích thực nghiệm và phát triển (Development Phase) linh hoạt, đồ án triển khai CSDL <code>SQLite</code> thay vì cài đặt các hệ thống máy chủ cồng kềnh như MySQL hay PostgreSQL. Mọi giao tiếp nhúng với CSDL được thực hiện gián tiếp thông qua thư viện ORM <code>SQLAlchemy</code>.</li>
</ul>
...
<p align="center" style="margin-top: 0.2in;">
  ...
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.3. Giao diện trung tâm Phân tích — Hỗ trợ nhập văn bản trực tiếp để kiểm chứng.</i>
</p>

<p align="center" style="margin-top: 0.2in;">
  <img src="image/03_Giao_dien_Nhap_Link.png" alt="Giao diện Nhập Link" width="100%" style="border: 1px solid #ccc; border-radius: 8px;">
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.4. Giao diện trung tâm Phân tích — Hỗ trợ dán liên kết (URL) của bài báo.</i>
</p>
...
<p align="center" style="margin-top: 0.2in;">
  ...
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.5. Báo cáo phân tích cảnh báo nguy cơ Tin Giả thông qua nguyên lý Thị giác hóa rủi ro (Màu Đỏ - Mức độ 100%).</i>
</p>
...
<p align="center" style="margin-top: 0.2in;">
  ...
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.6. Báo cáo phân tích xác thực Tin Thật an toàn (Màu Xanh lá cây - Mức độ 0%).</i>
</p>
...
<p align="center" style="margin-top: 0.2in;">
  ...
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.7. Trình diễn khả năng của Động cơ Giải thích: Hệ thống bóc tách rõ lý do bài báo được đánh giá là chuyên nghiệp và an toàn.</i>
</p>

<p align="center" style="margin-top: 0.2in;">
  <img src="image/9_TrangLichSu.png" alt="Quản lý Lịch sử" width="100%" style="border: 1px solid #ccc; border-radius: 8px;">
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.8. Màn hình Quản lý Lịch sử cá nhân với thiết kế dạng danh sách thẻ động (Dynamic Cards).</i>
</p>
...
<p align="center" style="margin-top: 0.2in; font-style: italic; margin-bottom: 0.05in;">Bảng 4.1. Hiệu năng của mô hình PhoBERT Fine-tuned Sequence Classification</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in"><b>c) Phân tích sự ổn định trên tập kiểm thử độc lập (Hold-out Test Set)</b></p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in"><b>Cách chạy:</b> <code>./run.sh test</code> hoặc <code>cd backend &amp;&amp; ./run_tests.sh</code>. Kết quả hiện tại: <b>38/38 PASSED</b> (~4 giây).</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Bảng 4.3 tổng hợp theo file test. Dưới đây, <b>38 kịch bản</b> được phân thành <b>7 nhóm chức năng</b> và liệt kê chi tiết tại Bảng 4.4 (ánh xạ FR từ Bảng 3.1):</p>
...
<p align="center" style="margin-top: 0.2in; font-style: italic; margin-bottom: 0.05in;">Bảng 4.4. Chi tiết từng kịch bản kiểm thử tự động (38 test cases)</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in"><i>Ghi chú cột FR:</i> ánh xạ Bảng 3.1; <code>—</code> = kiểm thử helper (<code>TextCleaner</code>), auth nội bộ, hoặc pipeline dữ liệu. API lỗi nghiệp vụ: HTTP <b>200</b> + <code>status=error</code> + <code>message</code> (TC-28–30, TC-32–33, …).</p>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in"><b>Đánh giá:</b> 100% (38/38) test cases đạt PASSED. Kiểm thử API dùng mock inference nên không phụ thuộc GPU/RAM PhoBERT; DB test tách biệt file <code>shieldai.db</code> production.</p>
...
<div align="center" style="margin-top: 20px; margin-bottom: 20px;">
  <p style="font-style: italic; margin-bottom: 10px;">Hình 4.9. Minh họa Kịch bản TC_01: Phân tích bài báo chính thống (0% Tin giả)</p>
...
<div align="center" style="margin-top: 20px; margin-bottom: 20px;">
  <p style="font-style: italic; margin-bottom: 10px;">Hình 4.10. Minh họa Kịch bản TC_03: Bóc trần thủ thuật lạm dụng hình thức (100% Tin giả)</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.06in">Nhìn chung, tiểu luận đã cung cấp một giải pháp khả thi và hiệu quả cho bài toán phát hiện tin giả trên không gian mạng Việt Nam, vừa đảm bảo tính hàn lâm khoa học trong thiết kế thuật toán, vừa đáp ứng được các tiêu chuẩn kỹ thuật khắt khe của một ứng dụng phần mềm thực tiễn.</p>
...
<ul style="line-height: 150%; margin-bottom: 0.06in; text-align: left; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Triển khai thành sản phẩm ShieldAI:</b> Đồ án đã đóng gói toàn bộ các thuật toán và module kỹ thuật phức tạp thành một nền tảng Web có tên gọi ShieldAI hỗ trợ người dùng cuối, sẵn sàng hỗ trợ cộng đồng trong việc kiểm chứng thông tin trên không gian mạng.</li>
</ul>
