...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">Ngày
bảo vệ: ....../....../20......</font></p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">Kết
quả: ....../10 điểm</font></p>
<p style="line-height: 100%; margin-bottom: 0in"><br/>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Thứ ba, xây dựng Động cơ giải thích thông minh (Explanation Engine):</b> Đây là mục tiêu mang tính đột phá của đề tài nhằm minh bạch hóa &quot;hộp đen&quot; AI. Cụ thể, yêu cầu đặt ra là lập trình một module chuyên biệt có khả năng bóc tách cấu trúc bài viết, chấm điểm từng thành phần câu từ và chỉ rõ các yếu tố bất thường (ví dụ: bôi đậm các cụm từ mang tính kích động hoặc phi logic). Từ đó, hệ thống không chỉ áp đặt kết quả &quot;Thật/Giả&quot; một cách khiên cưỡng mà còn đưa ra những bằng chứng logic, mang tính thuyết phục cao để người dùng tự đối chiếu và quyết định.</p>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Về phạm vi dữ liệu (Dataset Scope):</b> Đề tài chỉ giới hạn xử lý và phân loại các thông tin dưới dạng văn bản (text), được biên soạn hoàn toàn bằng <b>tiếng Việt</b>. Nguồn dữ liệu huấn luyện và kiểm thử được thu thập từ các bài báo điện tử chính thống, các trang thông tin tổng hợp, và các bài đăng công khai trên nền tảng mạng xã hội. Bài toán học máy được giới hạn ở cấp độ <b>phân loại nhị phân (Binary Classification)</b>, tức là mô hình chỉ đưa ra một trong hai nhãn dự đoán: Tin Thật (Real News) hoặc Tin Giả (Fake News).</p>

<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Về phạm vi kỹ thuật phân tích (Analytical Scope):</b> Hệ thống tập trung toàn bộ năng lực tính toán vào việc phân tích hình thái Ngôn ngữ Tự nhiên (NLP) thông qua văn bản và bóc tách các siêu dữ liệu (Metadata) đính kèm của bài viết. Do giới hạn về chuyên môn và tài nguyên xử lý đồ họa, đề tài <b>chưa</b> mở rộng phạm vi sang việc phân tích, phát hiện tin giả ở các định dạng truyền thông đa phương tiện tinh vi khác, chẳng hạn như nhận diện hình ảnh bị cắt ghép (Image Forgery) hay video/âm thanh giả mạo (Deepfake).</p>

<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Về phạm vi thuật toán và mô hình (Algorithmic Scope):</b> Quá trình thực nghiệm huấn luyện và tinh chỉnh (fine-tuning) được tập trung chủ yếu vào việc hiện thực hóa kiến trúc kết hợp (Hybrid Architecture) giữa mạng PhoBERT và mạng nơ-ron truyền thẳng (MLP) để xử lý Heuristics. Việc đánh giá và đối chiếu hiệu năng chỉ được thực hiện với một số thuật toán học máy cơ bản mang tính đại diện. Đề tài không đặt tham vọng thực nghiệm so sánh với toàn bộ các biến thể kiến trúc mạng Deep Learning phức tạp khác do giới hạn cố hữu về thời gian và tài nguyên phần cứng tính toán trên máy tính cá nhân.</p>

<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Về phạm vi ứng dụng phần mềm (Application Scope):</b> Nền tảng phần mềm Web (gồm Backend, Frontend và Database) được xây dựng nhằm mục đích thử nghiệm thực tiễn bản mẫu (PoC - Proof of Concept), minh họa một cách trực quan tính năng phát hiện và giải thích của mô hình AI đối với người dùng. Tại thời điểm hiện tại, ứng dụng chưa được tối ưu hóa để vận hành như một sản phẩm thương mại quy mô lớn; do đó, chưa tích hợp các cơ chế chịu tải phức tạp (Load Balancing), kiến trúc Microservices, hay các tiêu chuẩn bảo mật khắt khe cấp độ doanh nghiệp (Enterprise Security).</p>
<h2>1.4. Phương pháp nghiên cứu</h2>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Để giải quyết bài toán đặt ra và đạt được các mục tiêu nghiên cứu, đề tài kết hợp sử dụng các phương pháp nghiên cứu khoa học sau đây:</p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Phương pháp nghiên cứu lý thuyết:</b> Tổng hợp, phân tích và đánh giá các tài liệu, bài báo khoa học trong và ngoài nước liên quan đến Xử lý Ngôn ngữ Tự nhiên (NLP), kiến trúc mạng Transformer (đặc biệt là PhoBERT), các thuật toán Học máy và các kỹ thuật Giải thích AI (Explainable AI) được ứng dụng trong phát hiện tin giả.</li>
  <li style="margin-bottom: 0.05in;"><b>Phương pháp thu thập và phân tích dữ liệu:</b> Xây dựng quy trình tự động hóa (crawler) để thu thập dữ liệu từ các nguồn tin tức và mạng xã hội tiếng Việt. Tiến hành các bước làm sạch dữ liệu, chuẩn hóa văn bản, và dán nhãn dữ liệu thực tế nhằm xây dựng một bộ ngữ liệu (corpus) chất lượng phục vụ quá trình huấn luyện mô hình.</li>
  <li style="margin-bottom: 0.05in;"><b>Phương pháp thực nghiệm và mô hình hóa:</b> Thiết kế quy trình phát triển mô hình (Machine Learning Pipeline) bao gồm các bước: trích xuất đặc trưng (ngữ nghĩa và kinh nghiệm), huấn luyện mô hình kết hợp (Hybrid Architecture), và tối ưu hóa các siêu tham số (hyperparameters tuning). Quá trình này được thực hiện lặp đi lặp lại để tìm ra điểm cân bằng tối ưu giữa độ chính xác và khả năng giải thích.</li>
  <li style="margin-bottom: 0.05in;"><b>Phương pháp thống kê và đánh giá:</b> Sử dụng các độ đo đánh giá chuẩn hóa trong học máy (Accuracy, Precision, Recall, F1-score) để định lượng hiệu suất của hệ thống trên tập dữ liệu kiểm thử. Phân tích thống kê đối chiếu với các thuật toán phân loại truyền thống nhằm đánh giá độ hiệu quả và mức độ ổn định của giải pháp đề xuất.</li>
</ul>
<h2>1.5. Ý nghĩa khoa học và ý nghĩa thực tiễn</h2>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Đề tài nghiên cứu được thực hiện không chỉ nhằm giải quyết một bài toán kỹ thuật đơn thuần mà còn mang khát vọng đóng góp những giá trị bền vững cho cả giới học thuật và cộng đồng xã hội. Ý nghĩa của đồ án được khẳng định sâu sắc qua hai phương diện cốt lõi sau đây:</p>

<h3>1.5.1. Ý nghĩa khoa học</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Về phương diện học thuật và nghiên cứu cơ bản, đồ án mang lại những đóng góp mang tính tiên phong trong việc giải quyết bài toán phân loại thông tin độc hại trên môi trường không gian mạng bằng tiếng Việt. Cụ thể, ý nghĩa khoa học của đề tài được thể hiện qua ba khía cạnh:</p>
...
<h3>1.5.2. Ý nghĩa thực tiễn</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Không chỉ dừng lại ở các đóng góp về mặt lý thuyết, giá trị cốt lõi của đồ án còn nằm ở tính ứng dụng thực tiễn cao, hướng trực tiếp đến việc giải quyết một trong những vấn nạn nhức nhối nhất của xã hội số hiện nay. Ý nghĩa thực tiễn của đề tài được hiện thực hóa qua các khía cạnh sau:</p>

<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Một là, cung cấp một hệ sinh thái phần mềm bảo vệ người dùng cuối:</b> Với việc đóng gói thuật toán thành một ứng dụng Web hoàn chỉnh bao gồm Frontend tương tác động và Backend tốc độ cao, đồ án trao tận tay người dân một công cụ kiểm chứng thông tin trực quan, dễ sử dụng. Trước một luồng thông tin gây hoang mang, người dùng chỉ cần thao tác đơn giản để nhận được đánh giá về tính xác thực của tin tức kèm theo những &quot;chỉ điểm&quot; logic từ Động cơ giải thích, giúp họ tránh được bẫy lừa đảo, thao túng tâm lý và tự bảo vệ mình trên không gian mạng.</p>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Chương 4: Triển khai và Đánh giá thực nghiệm.</b> Chương này đóng vai trò chứng minh tính hiệu quả của các thiết kế trong Chương 3. Nội dung bắt đầu bằng việc mô tả quy trình tiền xử lý tập dữ liệu và các bước thiết lập môi trường huấn luyện. Tiếp theo, chương trình bày trực quan giao diện ứng dụng Web (Frontend/Backend) đã hoàn thiện. Phần quan trọng nhất là việc phân tích các Ma trận nhầm lẫn (Confusion Matrix) và công bố kết quả đo lường hiệu năng của mô hình (thông qua Accuracy, Precision, Recall, F1-Score), đồng thời đối chiếu trực diện với các thuật toán học máy truyền thống để làm nổi bật tính ưu việt của giải pháp.</p>

<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in"><b>Chương 5: Kết luận và Hướng phát triển.</b> Chương cuối cùng thực hiện nhiệm vụ tổng kết và đánh giá lại toàn bộ quá trình thực hiện đồ án. Chương sẽ điểm lại những mục tiêu đã đạt được, đồng thời thẳng thắn thừa nhận những mặt còn hạn chế trong kiến trúc phần mềm và năng lực của mô hình. Dựa trên những phân tích đó, chương sẽ đề xuất các hướng phát triển trong tương lai (như tối ưu hóa tải trọng hệ thống, tích hợp thêm nhận diện đa phương tiện Deepfake) để tiếp tục hoàn thiện giải pháp.</p>
<p style="line-height: 100%; margin-bottom: 0in"><br/>
...
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Điểm F1 (F1-Score):</b> Là trung bình điều hòa (Harmonic Mean) giữa Precision và Recall. Đây là chỉ số tối thượng (Ultimate Metric) được đồ án sử dụng làm tiêu chuẩn chính để quyết định mô hình nào hoạt động tốt nhất. F1-Score đảm bảo sự cân bằng hoàn hảo, buộc hệ thống vừa không được phép &quot;bắt nhầm&quot; (Precision cao) vừa không được &quot;bỏ sót&quot; (Recall cao).</li>
</ul>

<h3>2.1.7. Khai phá dữ liệu Web (Web Crawling và Scraping)</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Dữ liệu là &quot;nguồn nhiên liệu&quot; sống còn của mọi hệ thống AI. Khái niệm <b>Khai phá dữ liệu Web (Web Scraping/Crawling)</b> đề cập đến việc sử dụng các kịch bản lập trình tự động (bots/spiders) để duyệt qua các trang web, mô phỏng hành vi của con người nhằm trích xuất khối lượng lớn dữ liệu cấu trúc hoặc phi cấu trúc. Trong đồ án này, khái niệm này được áp dụng thực tế thông qua các module tự động thu thập bài báo điện tử và bài đăng mạng xã hội. Dữ liệu sau khi thu thập sẽ đi qua một bộ lọc làm sạch tự động (Dataset Cleaner) nhằm loại bỏ rác mã HTML, sửa lỗi chính tả trước khi chính thức đưa vào tập ngữ liệu (Corpus) phục vụ huấn luyện mô hình.</p>

<h3>2.1.8. Xác thực danh tính bảo mật (JSON Web Token - JWT)</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Trong kiến trúc phân tán (Client-Server), việc đảm bảo giao tiếp an toàn giữa Frontend và Backend là bắt buộc. <b>JSON Web Token (JWT)</b> là một tiêu chuẩn mở (RFC 7519) định nghĩa một cách thức nhỏ gọn và độc lập để truyền tải thông tin an toàn giữa các bên dưới dạng đối tượng JSON. Thông tin này có thể được xác minh và tin cậy vì nó được ký điện tử (digitally signed). Hệ thống trong đồ án không quản lý phiên bản (session) tĩnh trên server, mà sử dụng JWT (Bearer Token) để xác thực người dùng (Authentication) và phân quyền (Authorization). Mỗi khi người dùng yêu cầu quét tin giả hoặc gửi phản hồi, token này sẽ đóng vai trò như một &quot;hộ chiếu số&quot; để hệ thống API ghi nhận chính xác lịch sử truy vấn thuộc về ai.</p>

<h3>2.1.9. Cơ sở dữ liệu quan hệ (RDBMS) và Ánh xạ đối tượng (ORM)</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Khái niệm cuối cùng giúp đóng gói toàn bộ luồng dữ liệu của hệ thống là <b>Cơ sở dữ liệu quản lý quan hệ (RDBMS)</b> và <b>Ánh xạ Quan hệ - Đối tượng (ORM - Object Relational Mapping)</b>. RDBMS (trong đồ án này là SQLite) tổ chức dữ liệu thành các bảng có cấu trúc hàng cột nghiêm ngặt, đảm bảo tính toàn vẹn dữ liệu. Trong khi đó, ORM (cụ thể là thư viện SQLAlchemy được áp dụng trong dự án) đóng vai trò làm cầu nối, cho phép hệ thống giao tiếp với cơ sở dữ liệu bằng các đối tượng lập trình (Python Objects) thay vì phải viết các câu lệnh SQL thô phức tạp. Sự kết hợp này mang lại cho hệ thống khả năng lưu trữ, truy vấn và truy xuất chéo dữ liệu một cách cực kỳ an toàn giữa ba thực thể chính: Người dùng (Users), Lịch sử phân tích (Analysis History), và Đánh giá cộng đồng (Feedbacks).</p>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Để dung hợp (fusion) được tri thức từ mô hình ngữ nghĩa (PhoBERT) và tập đặc trưng hành vi (Heuristics), hệ thống sử dụng kiến trúc <b>Mạng nơ-ron truyền thẳng (Multi-Layer Perceptron - MLP)</b>. Lớp MLP này nhận đầu vào là một vector ghép nối (concatenated vector), bao gồm vector nhúng 768 chiều từ lớp ẩn cuối cùng của PhoBERT và vector số thực đại diện cho các chỉ số Heuristics.</p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Cấu trúc MLP bao gồm nhiều lớp kết nối đầy đủ (Fully Connected Layers) xen kẽ với các hàm kích hoạt phi tuyến tính (như ReLU) để học các hàm tương quan phức tạp. Tại đây, kỹ thuật <i>Dropout</i> (triệt tiêu nơ-ron ngẫu nhiên) được áp dụng nghiêm ngặt để chống hiện tượng học vẹt (over-fitting). Tại lớp đầu ra (Output Layer), một hàm <i>Sigmoid</i> được áp dụng để biến đổi các giá trị toán học thành không gian xác suất (từ 0.0 đến 1.0), đưa ra dự đoán phân loại cuối cùng cho bài báo.</p>

<h3>2.2.5. Cơ sở lý thuyết về Trí tuệ Nhân tạo Minh bạch (Explainable AI)</h3>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Việc giải thích quyết định của hệ thống được dựa trên hai cơ sở lý luận thuật toán chính. Thứ nhất là phương pháp <b>Phân bổ trọng số đặc trưng (Feature Attribution)</b>, nơi các giá trị phân tích của bộ Heuristics (ví dụ: văn bản có độ tiêu cực vượt ngưỡng 0.8) được đối chiếu trực tiếp với kết quả đầu ra để đưa ra các dòng cảnh báo logic.</p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Thứ hai là việc tận dụng chính các <b>Trọng số chú ý (Attention Weights)</b> từ bên trong các lớp nội bộ của mô hình Transformer. Bằng cách nội soi và quan sát xem ma trận Attention đang tập trung độ dốc (gradient) vào các từ khóa nào nhiều nhất khi dự đoán nhãn &quot;Tin Giả&quot;, Động cơ giải thích có thể trích xuất ngược lại các từ vựng mang tính quyết định. Quá trình này giúp gỡ bỏ lớp mặt nạ &quot;hộp đen&quot;, cho phép con người nhìn thấu được quy trình suy luận logic bên trong một mạng nơ-ron phức tạp.</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Dựa trên bức tranh tổng quan của các nghiên cứu đi trước, đồ án <b>ShieldAI</b> không chỉ kế thừa mà còn giải quyết được những hạn chế cốt lõi của các hệ thống phát hiện tin giả truyền thống. Dưới đây là bảng so sánh làm nổi bật tính tối ưu (Optimization) và sự đột phá của đồ án:</p>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>1. Khả năng Thấu hiểu Ngôn ngữ</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>ShieldAI (Tối ưu Ngữ nghĩa):</b> Cũng kế thừa sức mạnh của <b>PhoBERT</b> nhưng được tinh chỉnh (fine-tune) sâu sắc trên tập ngữ liệu y tế chuyên biệt (COVID-19, dịch bệnh). Mô hình được trang bị khả năng hiểu rõ ngữ pháp tiếng lóng và các thuật ngữ chuyên ngành, chặn đứng các thủ đoạn lừa đảo tinh vi về y tế.</li>
</ul>
...
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>ShieldAI (Tối ưu Niềm tin):</b> Tích hợp hệ thống <b>Động cơ Giải thích (XAI Engine)</b>. Phần mềm sẽ bóc tách các lớp trọng số bên trong và in ra màn hình lý do cảnh báo (ví dụ: "Tiêu đề viết hoa quá nhiều" hay "Văn phong giật gân, thiếu tính trung lập"). Giúp người dùng thực sự tin tưởng vào phán quyết của AI.</li>
</ul>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>4. Trải nghiệm & Khả năng Vận hành Thực tế</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>ShieldAI (Tối ưu Trải nghiệm):</b> Đóng gói thành sản phẩm phần mềm SaaS hoàn chỉnh. Tích hợp <b>BeautifulSoup</b> tự cào nội dung tin tức trực tiếp từ URL trong tích tắc. Backend dùng <b>FastAPI</b> bất đồng bộ (Asynchronous) để chịu tải song song hàng chục người dùng cùng lúc. Đưa AI ra khỏi phòng thí nghiệm và đến tay người dùng cuối (End-user).</li>
</ul>
<h2>2.4. Công nghệ và Công cụ sử dụng</h2>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in; text-indent: 0.5in">Đồ án này không chỉ dừng lại ở việc thiết kế một mô hình AI chạy trong môi trường nghiên cứu cô lập (Jupyter Notebook), mà được xây dựng thành một nền tảng phần mềm hoàn chỉnh theo kiến trúc Client-Server. Dưới đây là các công nghệ lõi được sử dụng để hiện thực hóa toàn bộ hệ thống:</p>

<h3>2.4.1. Ngôn ngữ lập trình</h3>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Python 3.10+:</b> Là ngôn ngữ lập trình chủ đạo được sử dụng xuyên suốt toàn bộ phía Server (Backend). Python được lựa chọn nhờ vào hệ sinh thái khổng lồ hỗ trợ Xử lý Ngôn ngữ Tự nhiên (NLP) và Trí tuệ Nhân tạo. Trong đồ án này, Python đảm nhận ba vai trò cốt lõi: (1) Tiền xử lý văn bản phức tạp (loại bỏ teencode, biểu thức chính quy), (2) Trích xuất đặc trưng Heuristics tính toán mật độ từ vựng, và (3) Vận hành Động cơ giải thích XAI. Khả năng giao tiếp mượt mà giữa Python và các thư viện biên dịch bằng C++ (như PyTorch) giúp mô hình đạt hiệu năng tính toán cao nhất.</li>
  <li style="margin-bottom: 0.05in;"><b>TypeScript:</b> Là phiên bản siêu tập (superset) nâng cấp của JavaScript, được sử dụng độc quyền ở phía giao diện người dùng (Frontend). Khác với JavaScript truyền thống, TypeScript ép buộc việc định nghĩa trước cấu trúc dữ liệu. Bằng cách sử dụng các <code>interface</code> như <code>AnalyzeResponse</code> hay <code>Feedback</code>, hệ thống đảm bảo tính chặt chẽ (type-safety) tuyệt đối khi Frontend giao tiếp với Backend API, qua đó loại bỏ hoàn toàn các lỗi phi logic (runtime errors) liên quan đến việc sai lệch cấu trúc JSON trong quá trình truyền tải mạng.</li>
</ul>
...
<h3>2.4.4. Cơ sở dữ liệu và Bảo mật</h3>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>SQLite & SQLAlchemy (ORM):</b> Hệ thống sử dụng cơ sở dữ liệu quan hệ cục bộ (RDBMS) SQLite nhờ tính chất nhẹ, không yêu cầu cấu hình server phức tạp nhưng vẫn đảm bảo tính toàn vẹn dữ liệu (ACID). SQLAlchemy được áp dụng làm lớp Ánh xạ Đối tượng (ORM - Object Relational Mapping), cho phép lập trình viên tương tác với cơ sở dữ liệu bằng các Class và Object thuần Python thay vì phải viết các câu lệnh truy vấn SQL thô cứng, từ đó giảm thiểu tối đa rủi ro bị tấn công SQL Injection.</li>
  <li style="margin-bottom: 0.05in;"><b>JWT (JSON Web Token) & Passlib (Bcrypt):</b> Được sử dụng để thiết lập cơ chế Phân quyền (Authentication) phi trạng thái (Stateless). Thư viện Passlib với thuật toán Bcrypt đảm nhiệm việc băm (hash) mật khẩu có thêm chuỗi muối (salt) ngẫu nhiên trước khi lưu vào DB, ngăn chặn hiệu quả các cuộc tấn công dò bảng băm (Rainbow Table). Phía client sẽ giao tiếp bằng mã thông báo JWT (Bearer Token), giúp server nhận diện người dùng mà không cần phải tốn bộ nhớ lưu trữ phiên làm việc (Session).</li>
</ul>

<h3>2.4.5. Công cụ Thu thập dữ liệu (Web Scraping)</h3>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Requests & BeautifulSoup 4 (bs4):</b> Để hỗ trợ người dùng trải nghiệm kiểm tra tin tức trực tiếp từ các đường dẫn mạng (URL) thực tế, hệ thống tích hợp bộ đôi thư viện Web Scraping kinh điển của Python. <code>Requests</code> đảm nhiệm việc gửi các truy vấn HTTP GET (kèm theo kỹ thuật giả mạo User-Agent để vượt qua các tường lửa chống Bot cơ bản). Trọng trách còn lại được giao cho <code>BeautifulSoup</code>, với khả năng duyệt cây DOM HTML mạnh mẽ, hệ thống sẽ tự động xác định các thẻ <b>p</b> và <b>h1</b> để bóc tách chính xác phần văn bản cốt lõi của bài báo, đồng thời loại bỏ hoàn toàn các thành phần nhiễu như quảng cáo, thẻ lệnh (script) hay thanh điều hướng.</li>
</ul>
<h2>2.5. Biện luận lựa chọn công nghệ và kiến trúc</h2>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Dựa trên các phân tích lý thuyết, mục này sẽ đưa ra các luận điểm chuyên sâu nhằm giải thích rõ lý do tại sao các công nghệ lõi lại được lựa chọn cho đồ án, đồng thời so sánh trực tiếp với các phương pháp truyền thống để làm nổi bật tính tối ưu của hệ thống.</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để giải quyết triệt để bài toán phát hiện tin giả tiếng Việt, đồ án không áp dụng một thuật toán học máy đơn lẻ mà xây dựng một quy trình luận giải đa tầng (Multi-tier Analytical Pipeline). Phương pháp nghiên cứu được chia thành bốn mũi nhọn chiến lược, đi từ khâu thu thập dữ liệu thô, trích xuất đặc trưng, mô hình hóa suy luận, cho đến việc minh bạch hóa kết quả.</p>

<h3>3.1.1. Lựa chọn Dữ liệu nghiên cứu (Dataset Selection)</h3>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Mọi hệ thống Trí tuệ Nhân tạo đều được định hình bởi chất lượng của nguồn dữ liệu huấn luyện (Data-driven approach). Nhằm đảm bảo mô hình có khả năng nhận diện các thủ đoạn lừa đảo tinh vi nhất, đồ án đã quyết định sử dụng bộ dữ liệu <b>"Vietnamese medical fake news dataset"</b> được công bố rộng rãi trên nền tảng khoa học dữ liệu Kaggle. Đây là một bộ ngữ liệu tiếng Việt được thu thập và dán nhãn (labeled) chuyên biệt, tập trung giải quyết phân khúc tin tức trong lĩnh vực y tế, sức khỏe và dịch bệnh.</p>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Quyết định lựa chọn bộ dữ liệu này xuất phát từ ba lý do mang tính chiến lược và học thuật:</p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Thứ nhất, Tính cấp thiết về mặt an sinh xã hội:</b> Khác với tin giả giải trí hay chính trị, tin giả y tế (như quảng cáo "thần dược", phương pháp chữa bệnh phản khoa học, tin đồn thất thiệt về dịch bệnh) gây ra những hệ lụy trực tiếp và nghiêm trọng đến sức khỏe, tài chính và thậm chí là tính mạng của người dân. Việc xây dựng một hệ thống AI tập trung làm sạch môi trường thông tin y tế mang lại giá trị ứng dụng thực tiễn và tính nhân văn rất cao.</li>
  <li style="margin-bottom: 0.05in;"><b>Thứ hai, Tính đặc thù và độ khó của ngữ liệu:</b> Các bài viết lừa đảo y tế thường sử dụng khéo léo các thuật ngữ chuyên môn kết hợp với cấu trúc câu thao túng tâm lý (giật gân, đe dọa, cam kết chữa khỏi 100%). Bộ dữ liệu này tạo ra một "thao trường" lý tưởng, đầy tính thử thách để kiểm chứng khả năng thấu hiểu ngữ cảnh phức tạp của mô hình ngôn ngữ lớn (PhoBERT).</li>
  <li style="margin-bottom: 0.05in;"><b>Thứ ba, Tương thích hoàn hảo với Kiến trúc Lai (Hybrid):</b> Sự xuất hiện dày đặc của các dấu hiệu lừa đảo thủ công trong nhóm tin giả y tế (như viết in hoa toàn bộ tựa đề để gây chú ý, lạm dụng dấu chấm than tạo sự hoảng loạn, nguồn tin mập mờ) chính là nguồn dữ liệu hoàn hảo để bộ đặc trưng kinh nghiệm (Heuristics) của hệ thống phát huy tối đa sức mạnh phân tích hành vi.</li>
</ul>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>Thông tin thống kê của bộ dữ liệu:</b> Qua quá trình đọc và phân tích cấu trúc, bộ dữ liệu gốc bao gồm tổng cộng <b>10.617 bản ghi (bài báo)</b>. Điểm sáng lớn nhất của bộ dữ liệu này là sự cân bằng tuyệt vời giữa các nhãn phân loại: có <b>5.692 bài báo thật (Real News - chiếm ~53,6%)</b> và <b>4.925 bài báo giả mạo (Fake News - chiếm ~46,4%)</b>. Tỷ lệ vàng này giúp loại bỏ hoàn toàn rủi ro mô hình bị thiên lệch (class imbalance) trong quá trình huấn luyện, đảm bảo thuật toán học được đặc trưng của cả hai loại tin một cách công bằng.</p>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Về mặt cấu trúc, mỗi bản ghi trong tập dữ liệu cung cấp một hệ thống trường thông tin (columns) vô cùng phong phú, bao gồm: <code>id</code>, <code>title</code> (tiêu đề), <code>url</code> (đường dẫn), <code>source</code> (nguồn phát hành), <code>summary</code> (tóm tắt), <code>content</code> (nội dung chi tiết), <code>published_at</code> (thời gian xuất bản) và nhãn phân loại <code>is_fake</code>. Chính sự nguyên vẹn của các trường <code>title</code> và <code>content</code> chưa qua xử lý đã cho phép đồ án tự do triển khai các thuật toán đếm dấu câu, đo lường tỷ lệ viết hoa và độ dài văn bản phục vụ cho luồng trích xuất đặc trưng kinh nghiệm (Heuristics) một cách trọn vẹn nhất.</p>

<h3>3.1.2. Phương pháp Thu thập Dữ liệu động và Tiền xử lý</h3>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Bên cạnh việc dùng dữ liệu tĩnh từ Kaggle để huấn luyện (Training), hệ thống cần phải hoạt động được trong môi trường thực tế (Real-time Inference) để đáp ứng nhu cầu của người dùng cuối. Đồ án sử dụng phương pháp khai phá dữ liệu tự động (Web Scraping) thông qua thư viện <code>BeautifulSoup</code> và <code>Requests</code> nhằm trích xuất nội dung từ các đường dẫn mạng do người dùng cung cấp. Để đảm bảo chất lượng dữ liệu đầu vào (Garbage In - Garbage Out), một quy trình tiền xử lý (Text Cleaner) được xây dựng. Phương pháp này áp dụng Biểu thức chính quy (Regular Expressions) để loại bỏ mã HTML thừa, chuẩn hóa dấu câu và lọc bỏ các ký tự nhiễu. Đặc biệt, công cụ <code>PyVi</code> được tích hợp để tiến hành tách từ (Word Tokenization), nhằm nối các từ ghép tiếng Việt bằng dấu gạch dưới (ví dụ: "tin_tức"), đảm bảo mô hình không bị mất mát ngữ nghĩa trước khi chuyển đổi sang dạng vector.</p>
...
<h3>3.1.4. Phương pháp Mô hình hóa lai ghép (Hybrid Architecture)</h3>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>1. Phân hệ Quản lý Tài khoản (User Management)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>2. Phân hệ Thu thập &amp; Tiền xử lý Dữ liệu (Data Scraping &amp; Preprocessing)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>4. Phân hệ Trí tuệ Nhân tạo Minh bạch (Explainable AI Engine - XAI)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>5. Phân hệ Quản lý Lịch sử (History Tracking)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Truy xuất Báo cáo cũ:</b> Cho phép người dùng xem lại kết quả phân loại và bảng báo cáo XAI của các bài báo cũ mà không cần phải bắt hệ thống phân tích lại từ đầu.</li>
</ul>
<h3>3.2.2. Yêu cầu phi chức năng</h3>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để đảm bảo hệ thống không chỉ là một mô hình học máy chạy trên môi trường cục bộ (Local) mà có thể sẵn sàng phục vụ người dùng cuối trong môi trường sản xuất (Production), các yêu cầu phi chức năng (Non-Functional Requirements) được định nghĩa khắt khe qua 5 khía cạnh sau:</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>2. Bảo mật và An toàn hệ thống (Security)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Bảo mật phiên làm việc:</b> Ứng dụng không sử dụng cookie truyền thống mà áp dụng kiến trúc không trạng thái (Stateless) với <b>JSON Web Token (JWT)</b>. Token này chỉ lưu trên bộ nhớ tạm của client, tự động hết hạn, giúp ngăn chặn triệt để tấn công CSRF.</li>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>3. Khả năng mở rộng và Tính khả dụng (Scalability &amp; Availability)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>4. Trải nghiệm người dùng (Usability &amp; UX)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  <li style="margin-bottom: 0.05in;"><b>Khả năng tương thích chéo (Responsive Design):</b> Giao diện Web phải hiển thị hoàn hảo trên cả trình duyệt máy tính (Desktop) lẫn thiết bị di động (Mobile). Các biểu đồ XAI phải được tối ưu kích thước để không bị tràn màn hình.</li>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>5. Khả năng bảo trì và Nâng cấp mô hình (Maintainability &amp; MLOps)</b></p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<h2>3.3. Thiết kế hệ thống</h2>
<h3>3.3.1. Kiến trúc hệ thống</h3>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Dựa trên các yêu cầu đã phân tích, hệ thống được thiết kế theo kiến trúc <b>Client-Server (Front-end & Back-end Separation)</b> nhằm tối đa hóa khả năng bảo trì và tốc độ xử lý. Cụ thể, kiến trúc hệ thống được chia làm ba tầng (Tiers) chính như minh họa dưới đây:</p>
...
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Vùng Phân tích Chuyên sâu (XAI Metrics):</b> Đây là khu vực mang lại giá trị cốt lõi nhất, nơi hiển thị các thanh đo (Progress bars) bóc tách chi tiết lý do tại sao văn bản lại bị AI đánh dấu như vậy. Các chỉ số như "Tỷ lệ lạm dụng viết hoa", "Mật độ sử dụng dấu chấm than", "Số lượng từ lóng", hay "Chỉ số cảm xúc tiêu cực" được trực quan hóa sinh động. Nhờ tận dụng cấu trúc Component của React, các thanh đồ thị này được thiết lập hiệu ứng chạy mượt mà từ 0% lên đến mức thực tế, tạo cho người dùng một cảm giác thỏa mãn khi thấy hệ thống đang "suy nghĩ" và giải trình rất minh bạch ngay trước mắt họ.</li>
</ul>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>3. Màn hình Quản lý Lịch sử (Personal History View)</b></p>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để tăng tính gắn kết cá nhân hóa, hệ thống cung cấp một bảng điều khiển lưu trữ toàn bộ các phiên phân tích trong quá khứ của người dùng. Màn hình này áp dụng thiết kế dạng danh sách thẻ động (Dynamic Cards), cho phép người dùng lướt nhanh qua các tiêu đề bài báo đã quét, thời gian thực hiện thao tác và đóng dấu nhãn Thật/Giả một cách rõ ràng. Điểm tối ưu về mặt UI/UX ở đây là việc triển khai tính năng phân trang (Pagination) ngay tại phía máy chủ kết hợp bộ lọc động, giúp giao diện Frontend có thể tải và cuộn qua hàng trăm bản ghi lịch sử một cách cực kỳ nhẹ nhàng, không gây tràn bộ nhớ (RAM) hay giật lag trình duyệt của người dùng.</p>
<h3>3.3.4. Thiết kế thuật toán (Thuật toán Kiến trúc Lai - Hybrid Architecture)</h3>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để giải quyết triệt để vấn đề mà các hệ thống phân loại truyền thống thường xuyên gặp phải—đó là việc quá phụ thuộc vào ý nghĩa từ vựng mà bỏ qua các thủ thuật thao túng tâm lý (ví dụ: dùng nhiều dấu chấm than, viết hoa in đậm để gây sốc)—đồ án đã tự thiết kế một thuật toán <b>Kiến trúc Lai (Hybrid Architecture)</b>. Triết lý thiết kế của thuật toán này là sự dung hợp (Fusion) sức mạnh giữa hai trường phái: Học Sâu (Deep Learning) chuyên phân tích ngữ nghĩa, và Khai phá Dữ liệu kinh nghiệm (Heuristics) chuyên phân tích hành vi người viết. Lưu đồ thuật toán dưới đây minh họa toàn bộ vòng đời của một luồng xử lý dữ liệu, từ lúc hệ thống tiếp nhận văn bản thô cho đến khi xuất ra phán quyết cuối cùng kèm theo bản báo cáo minh bạch (XAI).</p>

<pre><code class="language-mermaid">
flowchart TD
    Start([Bắt đầu: Nhận Văn bản/URL]) --> Preprocess[Tiền xử lý & Làm sạch Văn bản]
    Preprocess --> Split{Tách luồng xử lý song song}
    
    %% Luồng Ngữ Nghĩa PhoBERT
    Split -->|Luồng 1: Ngữ nghĩa| Tokenize[PhoBERT Tokenization]
    Tokenize --> BertForward[Qua các lớp Attention của PhoBERT]
    BertForward --> BertVec[Trích xuất Vector CLS 768 chiều]
    
    %% Luồng Đặc trưng Heuristics
    Split -->|Luồng 2: Heuristics| ExtractStats[Thống kê văn bản: Độ dài, Ký tự...]
    ExtractStats --> ExtractMeta[Mô phỏng Dữ liệu MXH: Followers, Tuổi Account...]
    ExtractMeta --> HeuristicVec[Tạo Vector Heuristics 10 chiều]
    
    %% Dung hợp & Phân loại
    BertVec --> Fusion((Dung hợp Vector\nConcatenation))
    HeuristicVec --> Fusion
    Fusion --> MLP[Mạng nơ-ron truyền thẳng - MLP]
    MLP --> Activation[Hàm kích hoạt Sigmoid]
    
    %% Đầu ra
    Activation --> Output{Giá trị > 0.5?}
    Output -->|Yes| Fake[Phân loại: Tin Giả]
    Output -->|No| Real[Phân loại: Tin Thật]
    
    Fake --> XAI[Chạy thuật toán XAI tính độ quan trọng]
    Real --> XAI
    XAI --> End([Kết thúc: Trả về Kết quả & Báo cáo XAI])
</code></pre>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Theo lưu đồ trên, thuật toán được thiết kế thành một cấu trúc phân nhánh xử lý song song, giúp tối ưu hóa toàn diện thời gian suy luận (Inference time). Chi tiết các bước thực thi của thuật toán diễn ra như sau:</p>
...
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
  ...
  <li style="margin-bottom: 0.05in;"><b>Bước 3: Dung hợp Đặc trưng (Feature Fusion):</b> Tại điểm giao thoa (Fusion Node), hệ thống sẽ thực hiện phép toán ghép nối ma trận (Concatenation). Cụ thể, vector 768 chiều (của PhoBERT) và vector 10 chiều (của Heuristics) được nối chặt lại thành một vector duy nhất có độ dài <b>778 chiều</b>. Khối dữ liệu lai dung hợp này mang trong mình sức mạnh kép: vừa hiểu ngữ nghĩa uyên bác, vừa nhạy bén với các mánh khóe lừa đảo.</li>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để tạo ra một nền tảng vận hành mượt mà, hạn chế tối đa các xung đột thư viện (Dependency conflicts) thường gặp trong quá trình biên dịch mô hình AI, đồ án đã lựa chọn và chốt cấu hình các công nghệ phần mềm cốt lõi như sau:</p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>Quy trình Tiền xử lý Dữ liệu Huấn luyện (Data Preprocessing Workflow)</b></p>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Trước khi được đưa vào quy trình tối ưu hóa trọng số của PyTorch, toàn bộ tập dữ liệu thô đã phải trải qua một quy trình thanh lọc ba bước nghiêm ngặt nhằm tránh các hiện tượng thiên vị và quá khớp:</p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="center" style="margin-top: 0.2in;">
  ...
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.4. Báo cáo phân tích cảnh báo nguy cơ Tin Giả cực độ thông qua nguyên lý Thị giác hóa rủi ro (Màu Đỏ).</i>
</p>
...
<p align="center" style="margin-top: 0.2in;">
  <img src="image/7_KetQua_TinGia_GiaiThichXAI.png" alt="Báo cáo giải thích XAI" width="100%" style="border: 1px solid #ccc; border-radius: 8px;">
  <br><i style="font-size: 0.9em; color: #555;">Hình 4.6. Trình diễn sức mạnh của Động cơ XAI: Hệ thống bóc tách rõ lý do bài báo bị đánh dấu lừa đảo (Giọng điệu kích động, lạm dụng dấu chấm than).</i>
</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Để minh chứng tính đúng đắn của phương pháp tiếp cận, đồ án không chỉ dựa vào đánh giá cảm quan trên giao diện mà còn tiến hành định lượng (Quantitative Evaluation) hệ thống bằng các độ đo học máy chuẩn mực. Thử nghiệm được tiến hành trên tập kiểm thử (Test Set) chứa 10% dữ liệu chưa từng được mô hình nhìn thấy trong quá trình huấn luyện.</p>

<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>a) Các độ đo đánh giá (Evaluation Metrics)</b></p>
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Hệ thống sử dụng ma trận nhầm lẫn (Confusion Matrix) để tính toán 4 chỉ số cốt lõi:</p>
<ul style="line-height: 150%; margin-bottom: 0.08in; text-align: justify; padding-left: 0.8in; margin-top: 0in;">
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>b) Kết quả so sánh trên tập kiểm thử</b></p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in"><b>Đánh giá:</b> 100% các Test Cases tự động đều đạt trạng thái PASSED với thời gian thực thi dưới 15 giây, khẳng định nền tảng Backend đủ vững chắc để vận hành trên môi trường thực tế (Production-ready).</p>
...
<p align="justify" style="line-height: 150%; text-indent: 0.5in; margin-bottom: 0.08in">Dưới đây là một số hình ảnh thực tế minh họa cho các kịch bản kiểm thử hộp đen đã được thực thi và xác nhận trên môi trường Frontend:</p>
...
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">[1] D. Q. Nguyen and A. T. Nguyen, "PhoBERT: Pre-trained language models for Vietnamese," in <i>Findings of the Association for Computational Linguistics: EMNLP 2020</i>, 2020, pp. 1037-1042.</font></p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">[2] S. Lee, "Vietnamese Medical Fake News Dataset," Kaggle, 2023. [Online]. Available: https://www.kaggle.com/datasets/leviettrieu369/vietnamese-medical-fake-news-dataset. [Accessed: Jun. 12, 2026].</font></p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">[3] X. Zhou and R. Zafarani, "A Survey of Fake News: Fundamental Theories, Detection Methods, and Opportunities," <i>ACM Computing Surveys (CSUR)</i>, vol. 53, no. 5, pp. 1-40, 2020.</font></p>
<p align="justify" style="line-height: 150%; margin-bottom: 0.08in"><font color="#000000">[4] K. Shu, A. Sliva, S. Wang, J. Tang, and H. Liu, "Fake News Detection on Social Media: A Data Mining Perspective," <i>SIGKDD Explor. Newsl.</i>, vol. 19, no. 1, pp. 22-36, 2017.</font></p>
