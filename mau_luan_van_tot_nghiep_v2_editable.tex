...
\begin{itemize}[label={--},leftmargin=0.75cm,itemsep=3pt]
    ...
    \item \textbf{Tính module hóa và khả năng MLOps (Maintainability):} Mô hình học sâu PhoBERT sau khi huấn luyện được đóng gói dưới dạng \textit{Artifacts} riêng biệt, tách rời khỏi mã nguồn điều phối (API). Thiết kế này tuân thủ nguyên tắc Tách biệt Mối quan tâm (Separation of Concerns), cho phép các nhà nghiên cứu thuận tiện tái huấn luyện và cập nhật trọng số mạng nơ-ron mà không gây đứt gãy luồng vận hành của máy chủ hệ thống [21].
\end{itemize}
